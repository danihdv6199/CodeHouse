...
public partial class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CustomerNumber).HasName("PRIMARY");
            ...
            entity.HasOne(d => d.SalesRepEmployeeNumberNavigation).WithMany(p => p.Customers)
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasOne(d => d.CustomerNumberNavigation).WithMany(p => p.Orders)
        ...
        modelBuilder.Entity<Payment>(entity =>
        {
            ...
            entity.HasOne(d => d.CustomerNumberNavigation).WithMany(p => p.Payments)
                .HasForeignKey(d => d.CustomerNumber)
                .OnDelete(DeleteBehavior.ClientSetNull)
